...
get_all_permission_definitions <- function() {
  data.frame(
    ...
    permission = c(
      ...
      "access_projects", "add_project", "edit_project", "delete_project", "assign_concepts", "edit_context",
    ...
    description = c(
      ...
      "Access Projects page", "Add projects", "Edit projects", "Delete projects", "Assign concepts to projects", "Edit project context",
